...
class CategoryVihicleRepairScreen extends StatelessWidget {
  final int userid;
  final String fullName;
  final String contactNumber;

  CategoryVihicleRepairScreen({
    Key? key,
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: FutureBuilder<List<Map<String, dynamic>>>(
          future: dbHelper.getJobsByCategory("Vehicle Repair"),
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Center(child: Text("No jobs found for Vehicle Repair"));
            } else {
