...
class CategoryTechnicalScreen extends StatelessWidget {
  final int userid;
  final String fullName;
  final String contactNumber;
  CategoryTechnicalScreen({
    Key? key,
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: FutureBuilder<List<Map<String, dynamic>>>(
          future: dbHelper.getJobsByCategory("Technical"),
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Center(child: Text("No jobs found for Technical"));
            } else {
