...
class CategoryLaundryScreen extends StatelessWidget {
  final int userid;
  final String fullName;
  final String contactNumber;
  CategoryLaundryScreen({
    Key? key,
    ...
    return MaterialApp(
      ...
      home: Scaffold(
        ...
        body: FutureBuilder<List<Map<String, dynamic>>>(
          future: dbHelper.getJobsByCategory("Laundry"),
          builder: (context, snapshot) {
            if (snapshot.connectionState == ConnectionState.waiting) {
              ...
              return Center(child: Text("No jobs found for Laundry"));
            } else {
